...
date: "Maio de 2022 - [VI SER International Seminar on Statistics with R](https://ser.uff.br) <br><br> <br>Código: [github.com/beatrizmilz/2022-SER-quarto](https://github.com/beatrizmilz/2022-SER-quarto) <br> <br> Slides: [beatrizmilz.github.io/2022-SER-quarto/](https://beatrizmilz.github.io/2022-SER-quarto/) <br> Licença: "
format: 
  revealjs:
    incremental: true   
    #logo: "img/logo.png"
...
-   O R Markdown é uma ferramenta muito boa para escrita técnica e científica reprodutível, possibilitando criar vários tipos de documentos.
    Porém, **o seu uso acaba ficando limitado à comunidade de pessoas que usam R**.
...
Veja a galeria: <https://quarto.org/docs/gallery>
...
::: columns
::: {.column width="50%"}
-   [Documentação do Quarto](https://quarto.org/docs/gallery/)
...
-   [Com a chegada do Quarto, o R Markdown vai desaparecer? Não.](https://yihui.org/en/2022/04/quarto-r-markdown/)
    - Post em inglês por [Yihui Xie](https://yihui.org/en/about/)
:::
